...
<div id="footer" class="bg-black">
      <div class="container">
            <p class="text-muted" align="center"><br>&copy; <?php echo date("Y"); ?> Developed by J. van Marion (NL) /
            <a href="https://github.com/nlmaca" target="_blank"><i class="fa fa-github-alt fa-lg">&nbsp;&nbsp;</i></a>
                   ...
                   <a href="mailto:jeroen@vanmarion.nl" target="_blank"><i class="fa fa-inbox fa-lg">&nbsp;&nbsp;</i></a>
            <br> Version 1.1</p>
      </div>
</div>
